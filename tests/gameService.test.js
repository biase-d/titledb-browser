...
describe('Game Service', () => {
    ...
    beforeEach(() => {
        ...
        vi.mocked(gameRepo.searchGames).mockResolvedValue({ games: [], total: 0 });
    ...
    describe('searchGames', () => {
        it('should call repo search with params', async () => {
            ...
            vi.mocked(gameRepo.searchGames).mockResolvedValue({
                games: [{ id: '1', title: 'Found Game' }],
                total: 1
            });
            ...
            expect(gameRepo.searchGames).toHaveBeenCalledWith(dbMock, params);
        });
    });
});
